...
*/
#define LED_INPUT_SELECTOR_L_INDEX 0
#define LED_INPUT_SELECTOR_R_INDEX 1
#define LED_GAIN_CONTROL_L_INDEX 2
#define LED_GAIN_CONTROL_R_INDEX 3
#define LED_CLIP_INDICATO_INDEXR 4
#define LED_14INCH_INDEX 5
#define LED_XLR_INDEX 6
#define LED_GAIN_CH1_INDEX 7
#define LED_GAIN_CH2_INDEX 8
#define LED_LINK_INDEX 9
#define LED_MASTERL_INDEX 10
#define LED_SLAVEL_INDEX 11
#define LED_MASTERR_INDEX 12
#define LED_SLAVER_INDEX 13
#define LED_CLIP_CH1_INDEX 14
#define LED_CLIP_CH2_INDEX 15
